...
export default function NGOReliefPage() {
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500 flex items-center gap-1">
                      <MapPin size={12} />
                      {claim.land.district}, {claim.land.upazila} — {claim.cropType} — {claim.lossPercentage}% loss — {claim.affectedArea} acres
                    </p>
                    {claim.verification && (
          ...
          {selectedClaim && (
            <div className="space-y-4">
              <div className="bg-gray-50 rounded-lg p-3 text-sm">
                ...
                <p className="text-gray-500">Loss: {selectedClaim.lossPercentage}% | Area: {selectedClaim.affectedArea} acres</p>
